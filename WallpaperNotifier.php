...
/**
 * Notifies builds via the wallpaper.
 *
...
class WallpaperNotifier extends Notifier
{
    ...
    private function updateBackground($data)
    {
        ...
        // Wallpaper is reloaded via script
...
END
            ...
            // It's Linux
            $commandLine = "gsettings set org.gnome.desktop.background picture-uri file:///$this->imagePath";
